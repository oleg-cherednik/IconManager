...
final class rle24 {
    ...
    public static int[] decompress(int width, int height, int[] data, int[] mask) {
        ...
        // In the 128x128 icons, we need to start 4 bytes ahead. There is often a ���� padding here for some reason. If we don't, the red channel
